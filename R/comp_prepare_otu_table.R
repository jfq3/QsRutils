#' Prepare OTU Table
#'
#' Make OTU tables for making comparisons of relative abundances among
#' treatments.
#'
#' @param expt.taxon.pc Phyloseq object from comp_prepare_phyloseq with
#'   percentages in the otu_table.
